...
#ifndef RONISHMUSICPLAYER_SWIFT_H
#define RONISHMUSICPLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RonishMusicPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17RonishMusicPlayer11AppDelegate")
...
SWIFT_CLASS("_TtC17RonishMusicPlayer17GenreButtonScreen")
@interface GenreButtonScreen : UIViewController
- (void)viewDidLoad;
- (IBAction)genreButtonTapped:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC17RonishMusicPlayer13SceneDelegate")
